...
import com.flexjob.engagement.application.application.port.input.SendMessageUseCase;
...
public class SendMessageService implements SendMessageUseCase {
    ...
    public MessageResponse sendMessage(SendMessageCommand command) {
        ...
        return MessageResponse.builder().id(message.getId()).messageText(message.getMessageText().getValue())
                .senderId(message.getSenderId()).sentAt(message.getSentAt()).build();
    }
}
