...
public class BookingPersistenceMapper {
    public BookingJpaEntity toJpaEntity(Booking booking) {
        return BookingJpaEntity.builder()
                ...
                .jobId(booking.getJobId()).employeeId(booking.getEmployeeId()).employerId(booking.getEmployerId())
    ...
    public Booking toDomain(BookingJpaEntity jpaEntity) {
        return Booking.builder()
                ...
                .jobId(jpaEntity.getJobId()).employeeId(jpaEntity.getEmployeeId()).employerId(jpaEntity.getEmployerId())
                .applicationId(jpaEntity.getApplicationId()).status(jpaEntity.getStatus())
                .dateRange(DateRange.of(jpaEntity.getStartDate(), jpaEntity.getEndDate()))
                .createdAt(jpaEntity.getCreatedAt()).build();
    }
}
